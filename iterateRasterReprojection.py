...
daysBetweenToggle = 1 # turn to 1 to use days between images as an iteration filter
...
for fileNow in allFiles:
	if fileNow.endswith('.tif') and fileNow[0:3] == 'LC8' and fileNow.split('_')[-1][0:4] != 'EPSG':
