...
if (args.nsidc_out_names):  # use nsidc name conventions and out directories
	...
	# WHA modified on 08 Sep 2015 to include step size in the directory name base. 11 Sep 2015 to add gfilt_sigma.
	out_file_dir=out_parent_dir+out_name_base+'_'+str(int(args.gfilt_sigma))+'_'+str(int(args.half_source_chip))+'_'+str(int(args.half_target_chip))+'_'+str(int(args.inc))+'/'
	os.makedirs(out_file_dir)
	#this is the filename format
	
	# WHA modified on 08 Sep 2015 to include step size in the file name base
	file_name_base=out_file_dir + out_name_base + '_'+str(int(args.half_source_chip))+'_'+str(int(args.half_target_chip))+'_'+str(int(args.inc))
